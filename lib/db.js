...
export async function initializeDatabase() {
    ...
    try { await sql`ALTER TABLE sites ADD COLUMN IF NOT EXISTS github_url TEXT`; } catch {}
    try { await sql`ALTER TABLE sites ADD COLUMN IF NOT EXISTS screenshot_url TEXT`; } catch {}
    try { await sql`ALTER TABLE sites ADD COLUMN IF NOT EXISTS tech_stack TEXT DEFAULT ''`; } catch {}
    try { await sql`ALTER TABLE sites ADD COLUMN IF NOT EXISTS featured BOOLEAN DEFAULT false`; } catch {}
    try { await sql`ALTER TABLE sites ADD COLUMN IF NOT EXISTS demo_url TEXT`; } catch {}
    try { await sql`ALTER TABLE sites ADD COLUMN IF NOT EXISTS tags TEXT DEFAULT ''`; } catch {}
